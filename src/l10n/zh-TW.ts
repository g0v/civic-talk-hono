export const messages = {
  ...
  adm_mat_link: '🔗 原始連結',
  adm_mat_author: '投稿者：',
  adm_mat_author_unknown: '（未登入時期的舊素材）',
  ...
  contrib_toast_login_required: "登入狀態已過期，請重新登入後再提交",
  contrib_back: "← 返回議題",
  ...
  contrib_login_expired_hint: "登入狀態已過期。請先把下方填好的內容複製起來再重新登入——登入會跳轉到 Google／GitHub，這一頁的內容不會保留。",
