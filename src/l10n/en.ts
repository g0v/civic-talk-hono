export const messages = {
  ...
  contrib_factcheck_token_expired: 'Your fact-check credential has expired. Please reload this page and try again.',
  contrib_factcheck_rate_limited: 'You have reached this minute’s fact-check limit. Please try again in about {seconds} seconds.',
  contrib_factcheck_rate_limited_generic: 'You have reached this minute’s fact-check limit. Please wait a moment and try again.',
