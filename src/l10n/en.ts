export const messages = {
  ...
  profile_moderation_rationale: 'Decision rationale: ',
  profile_moderation_snapshot: 'Content snapshot',
  profile_moderation_time: 'Time: ',
  ...
  banned_toast: 'Your account has been suspended and cannot perform this action. You can submit an appeal from Abuse & Appeals.',
  ...
  idx_role_label: 'Role',
  idx_role_citizen: 'Citizen',
  idx_role_volunteer: 'Volunteer',
  welcome_title: 'Welcome to Civic Talk',
  welcome_intro: 'Choose how you would like to participate. We will tailor issue ordering and page priorities to your role. You can switch roles from the navbar at any time.',
  welcome_citizen_desc: 'Read issue briefings, join discussions, and share your perspective on public issues.',
  welcome_citizen_priority: 'Prioritizes issues with briefings that are ready for discussion.',
  welcome_volunteer_desc: 'Collect materials and use your own AI tools to organize information into a shared foundation for public discussion.',
  welcome_volunteer_priority: 'Prioritizes issues that need materials or synthesis.',
  welcome_remember_role: 'Remember my role',
  welcome_remember_role_hint: 'Save this preference in this browser and apply it automatically next time.',
  welcome_hide_prompt: "Don't show this prompt again",
  welcome_hide_prompt_hint: 'You can still switch roles from the navbar at any time.',
  welcome_close: 'Close welcome prompt',
  welcome_later: 'Choose later',
  ...
  vol_s3_desc: 'Once enough public opinions are collected, run a re-synthesis to update all three sections: consensus, key disputes, and position map.',
  vol_gen_synthesis: 'Generate Re-synthesis Prompt',
  vol_s3_partial_hint: "Fields left blank will keep the previous version's value — you can update only some sections.",
  vol_submit_synthesis: 'Submit Re-synthesis',
  vol_toast_synthesis_ok: '✅ Re-synthesis saved!',
  vol_synth_done_hint: 'Re-synthesis updated consensus, disputes, and position map. The one-page briefing (Step 2) may now be out of date — consider re-running Step 2.',
  ...
  brief_consensus: '✅ Background Consensus',
  brief_disputes: '⚔️ Background Disputes',
  ...
  op_toast_copy_ok: '✅ OPINION.md copied to clipboard!',
  op_toast_copy_fail: 'Could not copy OPINION.md. Please download it instead.',
  ...
  adm_search_ph: 'Filter by keyword…',
  adm_search_no_result: 'No results for "{keyword}"',
  adm_search_total: '(of {total})',
  nav_about: 'About',
  nav_admin: 'Admin',
  nav_appeals: 'Abuse & Appeals',
  ...
  abt_how_desc: 'The platform guides you through five steps, from following an issue to synthesizing opinions:',
  abt_step1_label: 'FOCUS',
  abt_step1_title: 'Follow an issue',
  ...
  abt_step3_desc:
    "After reading the briefing, download OPINION.md and paste it into your AI chat so it can walk you through the issue from your own situation, then send the summary back. You can also agree, disagree or pass on other people's opinions; the tally stays hidden until you vote so it does not sway you, and the full data is always available as a CSV download.",
  // 公民意見投票（#107）：票值沿用 pol.is，1 同意、-1 不同意、0 略過
  vote_agree: 'Agree',
  vote_disagree: 'Disagree',
  vote_pass: 'Pass',
  vote_author_badge: 'You proposed this · counted as one agree',
  vote_hidden_hint: 'The tally appears after you vote',
  vote_change_hint: 'Click again to retract, or pick another option',
  vote_login_hint: 'Sign in to vote',
  vote_login_required: 'Please sign in to vote',
  vote_failed: 'Your vote did not go through. Please try again.',
  vote_export_title: 'Raw data download',
  vote_export_desc:
    'The tally stays hidden until you vote, but the raw data is always public. Files use the pol.is format and can be uploaded to Sensemaker as-is; authors and voters appear only as anonymous ids (p1, p2, …).',
  vote_export_comments: 'Download comments.csv (opinions and tallies)',
  vote_export_votes: 'Download votes.csv (one row per vote)',
  ...
  abt_principle_desc:
    'Throughout the process, every interaction between a person and AI — synthesizing materials, generating briefings, and forming a civic opinion through your own AI conversation — is done by volunteers using their own accounts. Many people have unused Claude / ChatGPT tokens every week. This platform turns that idle compute power into a public resource.',
  abt_principle_note_prefix: 'Civic Talk is open source. Head over to our ',
  abt_principle_note_link: 'GitHub repository',
  abt_principle_note_suffix: ' to file issues and pull requests.',
  ...
  contrib_factcheck_checking: 'Checking…Please wait for about 60 seconds…',
  ...
  contrib_factcheck_required: 'Complete a fact-check with an allowed result before submitting.',
  factcheck_verdict_supported: 'Supported',
  factcheck_verdict_mostly_supported: 'Mostly supported',
  factcheck_verdict_mixed: 'Mixed evidence',
  factcheck_verdict_mostly_refuted: 'Mostly refuted',
  factcheck_verdict_refuted: 'Refuted',
  factcheck_verdict_insufficient_evidence: 'Insufficient evidence',
  factcheck_verdict_unknown: 'Unable to determine',
  contrib_tips_title: '🙋 What materials help most?',
  contrib_tips_body:
    '• Constitution, laws, and administrative orders\n• Court rulings and judicial precedents\n• International conventions and global trends\n• Government docs\n• NGO statements\n• News reports with links\n• Representative social posts\n• Academic findings\n\nThe same material can be submitted by multiple people; the platform tracks consistency.',
  ...
  adm_rpt_source_ai: 'AI decision',
  adm_rpt_snapshot: 'Rejected content snapshot',
  adm_rpt_status_pending: 'Pending',
  adm_rpt_status_resolved_false: 'False Report',
  adm_rpt_status_resolved_abuse: 'Confirmed Abuse',
  adm_rpt_status_resolved_broken: 'Confirmed broken',
  ...
  // AI moderation and appeals (#29)
  adm_tab_moderation: 'AI Moderation & Appeals',
  adm_mod_title: 'AI Moderation & Appeals',
  adm_mod_appeals_title: 'Appeals',
  adm_mod_empty_appeals: 'No appeals',
  adm_mod_th_content: 'Rejected content snapshot',
  adm_mod_th_message: 'Appeal message',
  adm_mod_appeal_pending: 'Pending',
  adm_mod_appeal_upheld: 'Original action upheld',
  adm_mod_appeal_overturned: 'Original action overturned',
  adm_mod_type_rejected: 'Rejected submission',
  adm_mod_type_account_ban: 'Account ban',
  adm_mod_policy_spam: 'Spam and abuse',
  adm_mod_policy_sexual_content: 'Sexual content',
  adm_mod_policy_hate_speech: 'Personal attack / hate speech',
  adm_mod_policy_defamation: 'Defamation',
  adm_mod_policy_misinformation: 'Misinformation',
  adm_mod_policy_illegal: 'Illegal content',
  adm_mod_btn_uphold: 'Uphold',
  adm_mod_btn_overturn: 'Overturn and lift the account ban',
  adm_mod_confirm_uphold: 'Uphold the original action for this appeal?',
  adm_mod_confirm_overturn: 'Overturn this appeal and lift the account ban?',
  adm_mod_need_super_admin: 'Account-ban actions require super-admin privileges',
  adm_mod_toast_done: 'AI moderation action completed',
  adm_mod_toast_fail: 'AI moderation action failed. Please try again.',
  adm_mod_rationale: 'Model rationale: ',
  adm_mod_source_ai: 'AI automatic review',
  // Submission safety review and appeals (#29)
  moderation_hidden_title: 'Submission saved but temporarily hidden for automated review',
  moderation_hidden_body: 'Your submission was saved and is waiting for an admin review. If you believe this was a mistake, keep your content and submit an appeal.',
  moderation_hidden_notice_body: 'Your submission was saved and temporarily hidden. Go to Abuse & Appeals to review the content and submit an appeal.',
  moderation_hidden_placeholder: 'This content is temporarily hidden while an admin reviews the automated moderation result.',
  moderation_account_ban_title: 'Your account has been banned by an administrator',
  moderation_account_ban_body: 'If you believe this account action was mistaken, you can submit an appeal for admin review.',
  moderation_account_ban_notice_body: 'You cannot submit content right now. Go to Abuse & Appeals to review any account action you can appeal.',
  moderation_appeal_link: 'Go to Abuse & Appeals',
  moderation_policy_label: 'Category: ',
  moderation_policy_spam: 'Spam and abuse',
  moderation_policy_sexual_content: 'Sexual content',
  moderation_policy_hate_speech: 'Personal attacks and hate speech',
  moderation_policy_defamation: 'Defamation and unsubstantiated allegations',
  moderation_policy_misinformation: 'Misinformation',
  moderation_policy_illegal: 'Illegal content',
  moderation_rationale_label: 'Automated review rationale: ',
  moderation_appeal_message_label: 'Appeal message',
  moderation_appeal_message_placeholder: 'Explain why this decision or account action was mistaken, and add sources or context when helpful.',
  moderation_appeal_submit: 'Submit appeal',
  moderation_appeal_required: 'Please enter an appeal message',
  moderation_appeal_submitted: 'Appeal submitted. An admin will review it in the dashboard.',
  moderation_appeal_failed: 'Appeal submission failed. Please try again.',
  moderation_appeal_already_pending: 'An appeal is already pending.',
  moderation_appeal_report_not_found: 'This moderation report could not be found. Refresh and try again.',
  moderation_appeal_report_resolved: 'This moderation report has already been resolved and cannot be appealed again.',
  moderation_appeal_no_active_ban: 'There is no active account ban to appeal.',
  // Central list of items the current user can appeal
  appeals_eyebrow: 'Account and content safety',
  appeals_title: 'Abuse & Appeals',
  appeals_intro: 'This page lists automated moderation decisions and account actions you can currently appeal. An administrator will review each submitted appeal.',
  appeals_login_required: 'Please sign in to view items that belong to you and can be appealed.',
  appeals_loading: 'Loading appealable items…',
  appeals_load_failed: 'Appealable items could not be loaded. Please try again later.',
  appeals_retry: 'Reload',
  appeals_empty: 'There are currently no items you can appeal.',
  appeals_type_account_ban: 'Account action',
  appeals_type_issue: 'Issue',
  appeals_type_material: 'Material',
  appeals_type_opinion: 'Opinion',
