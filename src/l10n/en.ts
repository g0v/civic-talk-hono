export const messages = {
  ...
  adm_signed_in_as: 'Signed in: {name}',
  adm_badge: 'Admin',
  ...
  adm_mat_link: '🔗 Source',
  adm_mat_author: 'Contributed by: ',
  adm_mat_author_unknown: '(legacy material, submitted before sign-in was required)',
  ...
  abt_hero_desc: 'Public discourse is usually dominated by people who already have strong opinions. Those without a clear stance stay silent because the information barrier is too high — and the result is two camps talking past each other. Civic Talk uses AI to break this cycle.',
  ...
  abt_step2_desc: "Readers download OPINION.md, paste it into their own Claude / ChatGPT / Gemini, and let AI guide their thinking based on their own context. They then submit a summary of their views back to the platform.",
  abt_step3_label: 'SYNTHESIS',
  abt_step3_title: 'Aggregate and reflect',
  abt_step3_desc: 'Once enough individual opinions are collected, run another AI synthesis to discover new perspectives not covered by the original materials, update the briefing, and attract more participation.',
  abt_principle_title: 'One thing we insist on',
  abt_principle_desc: 'The platform never calls any AI API directly. All AI computation — material synthesis, briefing generation, re-synthesis — is done by volunteers using their own accounts. Many people have unused Claude / ChatGPT tokens every week. This platform turns that idle compute power into a public resource.',
  ...
  abt_role2_desc: 'Run the synthesis using your own AI tools and paste the results back into the platform. The platform auto-generates the prompt — just copy it into Claude / ChatGPT and paste the output back.',
  abt_role3_icon: '💬',
  ...
  abt_role4_desc: 'The project is fully open source — feel free to file issues, submit PRs, or fork and deploy your own instance. If you\'re interested in deliberative democracy or civic tech, we\'d love to hear from you.',
  ...
  contrib_toast_login_required: "Your session has expired. Please sign in again before submitting.",
  ...
  contrib_login_expired_hint: "Your session has expired. Copy what you have written below before signing in again — signing in navigates away and this page's content will not be kept.",
