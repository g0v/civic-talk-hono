export const messages = {
  ...
  adm_mod_suspensions_title: 'Suspension recommendations (high priority)',
  adm_mod_appeals_title: 'Appeals',
  adm_mod_empty_suspensions: 'No pending suspension recommendations',
  adm_mod_empty_appeals: 'No appeals',
  adm_mod_th_user: 'Account',
  adm_mod_th_count: 'Violations in one hour',
  adm_mod_th_window: 'Window start',
  adm_mod_th_status: 'Status',
  adm_mod_th_type: 'Type',
  adm_mod_th_content: 'Rejected content snapshot',
  adm_mod_th_message: 'Appeal message',
  adm_mod_th_actions: 'Actions',
  adm_mod_status_pending: 'Pending',
  adm_mod_status_confirmed: 'Suspension confirmed',
  adm_mod_status_dismissed: 'Recommendation dismissed',
  ...
  adm_mod_type_ban: 'Submission freeze / suspension',
  ...
  adm_mod_btn_confirm: 'Confirm suspension',
  adm_mod_btn_dismiss: 'Dismiss and unfreeze',
  adm_mod_btn_uphold: 'Uphold',
  adm_mod_btn_overturn: 'Overturn and unfreeze',
  adm_mod_confirm_ban: 'Confirm suspending this account? This calls Better Auth and cannot be undone here.',
  adm_mod_confirm_dismiss: 'Dismiss the recommendation and unfreeze submissions?',
  adm_mod_confirm_uphold: 'Uphold the original action for this appeal?',
  adm_mod_confirm_overturn: 'Overturn this appeal and lift the freeze/suspension?',
  adm_mod_need_super_admin: 'Confirming a suspension requires super-admin privileges',
  ...
  moderation_rejected_title: 'Submission did not pass the Community Guidelines review',
  moderation_rejected_body: 'This submission was not written to the public data. If you believe this was a mistake, keep your content and submit an appeal.',
  moderation_frozen_title: 'Submission temporarily frozen',
  moderation_frozen_body: 'Recent submissions from your account were repeatedly flagged by automated review, so new submissions are temporarily frozen. You can submit an appeal now.',
  moderation_frozen_toast: 'Submissions are paused pending admin review. You can submit an appeal.',
  ...
  moderation_appeal_message_placeholder: 'Explain why this decision or freeze was mistaken, and add sources or context when helpful.',
  ...
  moderation_appeal_no_active_suspension: 'There is no active freeze or suspension to appeal.',
} as const
